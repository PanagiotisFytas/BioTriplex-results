...
if system == "hpc":
    ...
    input_dir = "/home/pf376/rds/hpc-work/llama-models/bio_infer/100_percent/"
else:
...
for mode in ["test", ]:#"val", "train"]:
    ...
    for output_file in os.listdir(input_dir):
        if not output_file.endswith(suffix):
            continue
        if ("biotriplex_qamc" not in output_file) or (mode not in output_file) or\
                ("biotriplex_qa" not in output_file) or ("1shot" in output_file) or ("2shot" in output_file) or\
                ("3shot" in output_file) or ("4shot" in output_file) or ("genrel" in output_file):
            continue
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
